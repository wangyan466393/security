          ...
          <el-row>
            <el-col :span="24">
              <div class="suspect_box">
                ...
                <div class="suspect_info">
                  <p>嫌疑犯姓名：张某三</p>
                  <div v-for="(info,index) in suspectInfo" :key="index" class="suspect_text">
                    <div v-if="info.gender == 1">性别：男</div>
                    <div>身份ID：{{ info.identity_id }}</div>
                    <div>所犯案件：{{ info.case_type }}</div>
                    <div>案件类型：已报警在逃人员</div>
...
<script>
  ...
  export default {
        ...
        suspectInfo: [
          {
            ...
            gender: 1,
            person_img:
              "",
            identity_id: "370101199002230302",
            case_type: "诈骗案",
            escape_time: "2019-12-01T12:00:00+08:00",
            status: 2,
            update_time: "2020-06-08T15:35:24.047361+08:00"
          }
        ]
      };
    },
    ...
    methods: {
      ...
      //获取在逃疑犯数据
      escapedInfo(){
        this.$axios.get("/escape_persons",{
          params:{
            identity_id:this.personId,
            token:"e13b652ac752169206e56e0502982dd1"
          }
